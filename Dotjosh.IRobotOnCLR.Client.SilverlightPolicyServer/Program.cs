...
namespace PolicyServer
{
	...
	public class Program
	{
		static void Main()
		{
			...
			PolicyServer ps =
				new PolicyServer(@"C:\Users\jschwartzberg\Documents\Visual Studio 2010\Projects\IRobotOnCLR\Dotjosh.IRobotOnCLR.Client.SilverlightPolicyServer\clientaccesspolicy.xml");
